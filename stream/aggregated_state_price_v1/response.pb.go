...
type StreamAggregatedStatePriceResponseV1 struct {
	...
	AggregatedPriceEth string `protobuf:"bytes,4,opt,name=aggregated_price_eth,json=aggregatedPriceEth,proto3" json:"aggregated_price_eth,omitempty"`
...
func (x *StreamAggregatedStatePriceResponseV1) GetAggregatedPriceEth() string {
	if x != nil {
		return x.AggregatedPriceEth
	}
	return ""
}
...
var file_sdk_stream_aggregated_state_price_v1_response_proto_rawDesc = []byte{
	...
	0x67, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f, 0x65, 0x74, 0x68, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65,
	0x64, 0x50, 0x72, 0x69, 0x63, 0x65, 0x45, 0x74, 0x68, 0x12, 0x35, 0x0a, 0x08, 0x74, 0x73, 0x5f,
